  ...
  return (
    <Box component="footer" sx={{ bgcolor: '#333', color: '#fff', py: 6 }}>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2" sx={{ mb: 2 }}>
              Job Zen is a leading job portal that connects job seekers with
          ...
          <Grid item xs={12} md={4}>
            ...
            <IconButton
              href="https://www.linkedin.com/company/naukri/"
              target="_blank"
              rel="noopener"
              color="inherit"
              sx={{ mr: 1 }}
            ...
            <IconButton
              href="https://www.instagram.com/naukri/"
              target="_blank"
              rel="noopener"
              color="inherit"
            >
      ...
      <Typography variant="body2" sx={{ textAlign: 'center' }}>
        © {new Date().getFullYear()} Job Zen. All rights reserved.
      </Typography>
    </Box>
  );
};
